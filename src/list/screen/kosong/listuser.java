...
public class listuser extends javax.swing.JFrame {
    ...
    public listuser() {
        initComponents();
        dataTable = c.selectUser();
        data = new Object[dataTable.size()/2][2];
        int z = 0 ;
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("List User"));
